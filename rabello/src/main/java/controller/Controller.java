 ...
 */
@WebServlet(urlPatterns = { "/Controller", "/main", "/mainusu", "/mainsoli", "/maincar", "/inserir", "/inserirusu", "/inserircar", "/solicitar", "/select", "/selectusu", "/selectcar", "/update", "/updateusu", "/updatecar", "/delete", "/deleteusu", "/deletecar", "/login" })
public class Controller extends HttpServlet {
	...
	protected void listarUsuario(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("editarusu.jsp");
		rd.forward(request, response);
	}
	...
	protected void alterarUsuario(HttpServletRequest request, HttpServletResponse response)
		...
		this.usuario.setNome_cli(request.getParameter("nome_usu"));
		this.usuario.setEmail_cli(request.getParameter("email_usu"));
		this.usuario.setTelefone_cli(request.getParameter("telefone_usu"));
