...
<html lang="pt-br">
  ...
  <body id="body-pd">
    ...
    <main class="main">
      ...
      >
        <b class="client-id col-md-3 col-12"
          ><%=lista.get(i).getFabricante_car()%></b
        >
        <b class="client-name col-md-3 col-12"
          ><%=lista.get(i).getModelo_car()%></b
        >
        <b class="client-name col-md-3 col-12"
          ><%=lista.get(i).getCor_car()%></b
        >
        <div class="client-buttons col-md-3 col-12">
          <a
            href="selectcar?id_car=<%=lista.get(i).getId_car()%>"
