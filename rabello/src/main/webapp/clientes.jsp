<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <%@ page import="model.JavaBeans"%> 
    ...
    <html lang="pt-br">
      ...
      <body id="body-pd">
        ...
        <main class="main">
          ...
          >
            <b class="client-id col-md-1 col-12"
              ><%=lista.get(i).getId_cli()%></b
            >
