...
i++) { out.print(lista.get(i).getId_cli());
	...
	<div class="l-navbar" id="nav-bar">
		<nav class="nav">
			<div>
				...
				<div class="nav_list">
					<a href="main" class="nav_link active"> <i
					...
					</a> <a href="maincar" class="nav_link"> <i class="fa-solid fa-cars"></i> <span class="nav_name">Carros</span>
	...
	<main class="main">
		...
		<div
			...
			<div class="client-buttons col-md-3 col-12">
				<a href="select?id_cli=<%=lista.get(i).getId_cli()%>"
