...
<body id="body-pd">
	...
	<div class="l-navbar" id="nav-bar">
		<nav class="nav">
          ...
          <div class="nav_list">
            ...
            <a href="mainusu" class="nav_link active">
	...
	<main class="main">
		...
		<div
			...
			<b class="client-id col-md-1 col-12"><%=lista.get(i).getId_usu()%></b>
			<b class="client-name col-md-4 col-12"><%=lista.get(i).getNome_usu()%></b>
			<b class="client-name col-md-4 col-12"><%=lista.get(i).getEmail_usu()%></b>
			<div class="client-buttons col-md-3 col-12">
				<a href="selectusu?id_usu=<%=lista.get(i).getId_usu()%>"
					class="client-edit btn">Editar</a> <a
					href="javascript: confirmarUsu(<%=lista.get(i).getId_usu()%>)"
